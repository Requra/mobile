...
<div class="frame">
  ...
  <div class="actions">
    ...
    <button class="btn"><span class="icon">✏️</span>Edit Details</button>
    <button class="btn primary"><span class="icon">▶</span>Start Meeting</button>
  ...
  <div class="stack">
    ...
    <div class="card">
      ...
      <div class="status-row"><span class="dot"></span><span>SCHEDULED</span></div>
    </div>
