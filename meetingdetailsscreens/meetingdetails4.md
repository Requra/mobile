...
<div class="frame">
  ...
  <div class="actions">
    <button class="btn purple"><span class="icon">📹</span>Join Now</button>
    <button class="btn"><span class="icon">👤</span>Invite</button>
    <button class="btn danger-solid"><span class="icon">■</span>End Meeting</button>
    <button class="btn danger"><span class="icon">⊗</span>Cancel Meeting</button>
  </div>
  ...
  <div class="stack">
    ...
    <div class="card">
      ...
      <div class="status-row"><span class="dot live"></span><span>LIVE</span></div>
